package com.guofeilong.fortune.pulltorefresh;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
			...
			if (mShowViewWhileRefreshing) {
				...
				OnSmoothScrollFinishedListener listener = new OnSmoothScrollFinishedListener() {
					...
					public void onSmoothScrollFinished() {
						callRefreshListener();
						if (null != mRefreshEndScrollFinishedListener) {
							mRefreshEndScrollFinishedListener.onScrollFinish();
						}
					}
				};
				...
				case PULL_FROM_END:
					...
					if (null != mRefreshEndScrollFinishedListener) {
						mRefreshEndScrollFinishedListener.onScroll();
					}
					break;
				default:
				case PULL_FROM_START:
	...
	public RefreshEndScrollListener mRefreshEndScrollFinishedListener;

	public void setRefreshEndScrollListener(RefreshEndScrollListener listener) {
		mRefreshEndScrollFinishedListener = listener;
	}

	/**
	 * 刷新完成后控件的滑动
	 */
	public static interface RefreshEndScrollListener {
