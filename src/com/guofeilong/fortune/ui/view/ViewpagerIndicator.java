...
public class ViewpagerIndicator extends LinearLayout {
	...
	public ViewpagerIndicator(Context context, AttributeSet attrs, int defStyle) {
		...
		paint = new Paint();
		paint.setColor(getResources().getColor(R.color.conmmd_blue));
	...
	private TextView generateTextView(String text) {
		...
		tv.setTextColor(getResources().getColor(R.color.conmmd_yellow));
		tv.setText(text);
	...
	protected void highLightTextView(int position) {
		...
		if (view instanceof TextView) {
			((TextView) view).setTextColor(getResources().getColor(R.color.conmmd_blue));
		}
	...
	private void resetTextViewColor() {
		for (int i = 0; i < getChildCount(); i++) {
			View view = getChildAt(i);
			if (view instanceof TextView) {
				((TextView) view).setTextColor(getResources().getColor(R.color.conmmd_yellow));
			}
		}
	}
}
