...
public class DragImageView extends ImageView implements OnGlobalLayoutListener {
	...
	public void setImageBitmap(Bitmap bm) {
		super.setImageBitmap(ViewUtils.toRoundBitmap(bm));
	}
	...
	private void animToTarget(MyPoint p, long distance) {
		...
		animTranslate.setAnimationListener(new AnimationListener() {
			...
			public void onAnimationEnd(Animation animation) {
				...
				moveToTarget();
				if (mOnclickListener != null) {
					mOnclickListener.onDragImageViewMoveToTarget(DragImageView.this);
				}
	...
	public void setTargetView(ImageView targetImageView) {
