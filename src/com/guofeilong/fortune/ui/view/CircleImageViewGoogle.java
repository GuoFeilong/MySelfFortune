...
public class CircleImageViewGoogle extends ImageView {
	...
	public CircleImageViewGoogle(Context context) {
		super(context);

		init();
	}

	public CircleImageViewGoogle(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public CircleImageViewGoogle(Context context, AttributeSet attrs, int defStyle) {
