...
public class WheelView extends View {
	...
	private static final int[] SHADOWS_COLORS = new int[] { 0xFF111111, 0x00FFFFFF, 0x00AAAAAA };
	...
	private int getDesiredHeight(Layout layout) {
		...
		int desired = getItemHeight() * visibleItems - mItem_offset * 2 - ADDITIONAL_ITEM_HEIGHT;
	...
	protected void onDraw(Canvas canvas) {
		...
		if (itemsWidth > 0) {
			...
			canvas.translate(PADDING, -mItem_offset);
			drawItems(canvas);
			drawValue(canvas);
			canvas.restore();
		}
