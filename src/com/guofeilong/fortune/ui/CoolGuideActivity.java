...
import com.guofeilong.fortune.ui.coolguide.TransitionPlayer;

import java.lang.reflect.Field;
import java.util.ArrayList;
import java.util.List;

public class CoolGuideActivity extends BaseActivity implements OnClickListener, ViewPager.OnPageChangeListener {
	private int mColor;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		extraPager.setOnPageChangeListener(this);
