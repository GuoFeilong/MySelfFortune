...
public class VolleyNetWorkRequest extends JsonRequest<JSONObject> {
	...
	public VolleyNetWorkRequest(int method, String url, Map<String, String> postParams, Listener<JSONObject> listener, ErrorListener errorListener) {
	...
	public VolleyNetWorkRequest(String url, List<NameValuePair> params, Listener<JSONObject> listener, ErrorListener errorListener) {
		this(Method.GET, urlBuilder(url, params), null, listener, errorListener);
	}

	public VolleyNetWorkRequest(String url, Listener<JSONObject> listener, ErrorListener errorListener) {
